# Angular App template [![Build Status](https://travis-ci.org/deniszholob/angular-app-template.svg?branch=master)](https://travis-ci.org/deniszholob/angular-app-template)
